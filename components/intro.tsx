    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://firebasestorage.googleapis.com/v0/b/portfolio-511e7.appspot.com/o/profile.jpg?alt=media&token=082c1da8-cc7b-4afa-9d0a-744387e35ba1"
      ...
      >
        <span className="font-bold">Hello, I&apos;m Umer Sufian.</span>{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/muhammad-umer-sufian-21b1b3285/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
